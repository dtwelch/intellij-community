...
public interface ResTypes {
  ...
  IElementType CONCEPT_ENHANCEMENT_MODULE_DECL = new ResCompositeElementType("CONCEPT_ENHANCEMENT_MODULE_DECL");
  ...
  IElementType MATH_AND_OR_APPLY_EXP = new ResCompositeElementType("MATH_AND_OR_APPLY_EXP");
  IElementType MATH_AND_OR_OP_EXP = new ResCompositeElementType("MATH_AND_OR_OP_EXP");
  ...
  IElementType MATH_COMPREHENSION_EXP = new ResCompositeElementType("MATH_COMPREHENSION_EXP");
  IElementType MATH_EQUALS_APPLY_EXP = new ResCompositeElementType("MATH_EQUALS_APPLY_EXP");
  IElementType MATH_EQUALS_NOT_EQUALS_OP_EXP = new ResCompositeElementType("MATH_EQUALS_NOT_EQUALS_OP_EXP");
  ...
  IElementType MATH_QUOTED_EXP = new ResCompositeElementType("MATH_QUOTED_EXP");
  ...
  IElementType MATH_TERM_TY_EXP = new ResCompositeElementType("MATH_TERM_TY_EXP");
  ...
  IElementType PROG_EQUALS_INFIX_EXP = new ResCompositeElementType("PROG_EQUALS_INFIX_EXP");
  ...
  IElementType WITH_CLAUSE = new ResCompositeElementType("WITH_CLAUSE");

  IElementType ALTERS = new ResTokenType("alters");
  IElementType AND = new ResTokenType("∧");
  ...
  IElementType EEXISTS = new ResTokenType("Exists");
  IElementType EFORALL = new ResTokenType("Forall");
  ...
  IElementType MATHIDENTIFIER = new ResTokenType("mathidentifier");
  ...
  IElementType OR = new ResTokenType("∨");
  IElementType OTHERWISE = new ResTokenType("otherwise");
  IElementType PIECEWISE = new ResTokenType("|{");
  ...
  class Factory {
    public static PsiElement createElement(ASTNode node) {
      IElementType type = node.getElementType();
       if (type == ARGUMENT_LIST) {
      ...
      else if (type == CONCEPT_ENHANCEMENT_MODULE_DECL) {
        return new ResConceptEnhancementModuleDeclImpl(node);
      }
      ...
      else if (type == MATH_AND_OR_APPLY_EXP) {
        return new ResMathAndOrApplyExpImpl(node);
      }
      else if (type == MATH_AND_OR_OP_EXP) {
        return new ResMathAndOrOpExpImpl(node);
      }
      ...
      else if (type == MATH_COMPREHENSION_EXP) {
        return new ResMathComprehensionExpImpl(node);
      }
      else if (type == MATH_EQUALS_APPLY_EXP) {
        return new ResMathEqualsApplyExpImpl(node);
      }
      else if (type == MATH_EQUALS_NOT_EQUALS_OP_EXP) {
        return new ResMathEqualsNotEqualsOpExpImpl(node);
      }
      ...
      else if (type == MATH_QUOTED_EXP) {
        return new ResMathQuotedExpImpl(node);
      }
      ...
      else if (type == MATH_TERM_TY_EXP) {
        return new ResMathTermTyExpImpl(node);
      }
      ...
      else if (type == PROG_EQUALS_INFIX_EXP) {
        return new ResProgEqualsInfixExpImpl(node);
      }
        ...
        return new ResWithClauseImpl(node);
      }
