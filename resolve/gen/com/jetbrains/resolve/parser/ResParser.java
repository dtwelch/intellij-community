...
public class ResParser implements PsiParser, LightPsiParser {
  ...
  public static final TokenSet[] EXTENDS_SETS_ = new TokenSet[] {
    ...
    create_token_set_(MATH_ALTERNATIVE_EXP, MATH_ALTERNATIVE_ITEM_EXP, MATH_AND_OR_APPLY_EXP, MATH_AND_OR_OP_EXP,
      MATH_ASSERTION_EXP, MATH_BINDER_APP_EXP, MATH_CART_PROD_EXP, MATH_EQUALS_APPLY_EXP,
      ...
      MATH_QUANTIFIED_EXP, MATH_REFERENCE_EXP, MATH_SELECTOR_EXP, MATH_TYPE_ASSERTION_EXP,
      RECORD_TYPE, TYPE),
  };
  ...
  /* ********************************************************** */
  // !('Type'|'Operation'|'Definition'|'Valued'|'Literal'|'Generic'|constraints|end)
  ...
  static boolean MathDefnSig(PsiBuilder b, int l) {
    ...
    if (!r) r = consumeToken(b, MATHPOSTFIXDEFNSIG);
  ...
  /* ********************************************************** */
  // ('Literal')? ('Generic')? ('Coercer')? ('Valued')? ('Implicit')?
  // 'Definition'  MathDefnSig (TRIANGLEQ MathAssertionExp)? ';'
  public static boolean MathStandardDefnDecl(PsiBuilder b, int l) {
    ...
    r = r && MathStandardDefnDecl_4(b, l + 1);
    r = r && consumeToken(b, DEFINITION);
    p = r; // pin = 6
    r = r && report_error_(b, MathDefnSig(b, l + 1));
    r = p && report_error_(b, MathStandardDefnDecl_7(b, l + 1)) && r;
    r = p && consumeToken(b, SEMICOLON) && r;
    exit_section_(b, l, m, r, p, null);
    return r || p;
  }
  ...
  // (TRIANGLEQ MathAssertionExp)?
  private static boolean MathStandardDefnDecl_7(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "MathStandardDefnDecl_7")) return false;
    MathStandardDefnDecl_7_0(b, l + 1);
    return true;
  }

  // TRIANGLEQ MathAssertionExp
  private static boolean MathStandardDefnDecl_7_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "MathStandardDefnDecl_7_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeToken(b, TRIANGLEQ);
  ...
  /* ********************************************************** */
  // CMD|identifier|int|symbol|mathsymbol|true|false
  ...
  /* ********************************************************** */
  // !('Definition'|'Implicit'|'Generic'|'Literal'|'Theorem'|'Corollary'|'Categorical'|'Inductive'|'Recognition'|'Coercer'|'Valued'|end)
  ...
  /* ********************************************************** */
  // !('Type'|'Operation'|'Facility'|'Recursive'|'Definition'|'Generic'|'Literal'|'Procedure'|end)
  ...
  //    ATOM(MathAlternativeExp) ATOM(MathEqualsNotEqualsOpExp) ATOM(MathAndOrOpExp) BINARY(MathTypeAssertionExp)
  //    ATOM(MathOutfixApplyExp) ATOM(MathCartProdExp) BINARY(MathBinderAppExp)
  ...
  public static boolean MathExp_0(PsiBuilder b, int l, int g) {
    ...
    while (true) {
      ...
      else if (g < 5 && leftMarkerIs(b, MATH_REFERENCE_EXP) && MathBinderAppExp_0(b, l + 1)) {
        r = MathExp(b, l, 5);
        exit_section_(b, l, m, MATH_BINDER_APP_EXP, r, true, null);
      }
      else {
        exit_section_(b, l, m, null, false, false, null);
        break;
  ...
  // MathVarDecl ','
  private static boolean MathBinderAppExp_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "MathBinderAppExp_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = MathVarDecl(b, l + 1);
